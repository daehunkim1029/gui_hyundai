...
class Thread(QThread):
    ...
    def __init__(self, wrapper: MMSegWrapper, path):
    ...
    def run(self):
        try:
            if os.path.exists(self.__path):
                dst_filename, result_dict = self.__wrapper.get_result(self.__path)
...
class MainWindow(QMainWindow):
    ...
    def __initUi(self):
        self.setWindowTitle('PyQt MMSegmentation GUI')
    ...
    def __run(self):
        ...
        self.__t = Thread(self.__wrapper, src_pathname)
